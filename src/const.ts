...
export const ACTIVE_PRIMARY_BUTTON =
    'bg-green-500 hover:bg-green-700 active:bg-green-800 px-4 py-2 rounded-md text-white'
export const ACTIVE_SECONDARY_BUTTON =
    'bg-rose-500 hover:bg-rose-700 active:bg-rose-800 px-4 py-2 rounded-md text-white'

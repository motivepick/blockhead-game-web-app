            ...
            <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                <div className="overflow-x-auto">
                    <table className="min-w-full">
                        ...
                        <thead className="border-b  bg-indigo-100 border-indigo-200">
                        <tr>
                        ...
                        <tbody>
                        {
                            zip(wordsByUser, wordsByComputer)
                                .map(([userWord, computerWord], i) => <tr className="border-b" key={`move${i}`}>
                                    <td className="text-sm text-gray-900 font-medium px-6 py-4 whitespace-nowrap">{userWord}</td>
                                    <td className="text-sm text-gray-900 font-medium px-6 py-4 whitespace-nowrap">{computerWord}</td>
                                </tr>)
                        }
                        </tbody>
                        <tfoot>
